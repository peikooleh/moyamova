...
window.decks.de_particles_lernpunkt = [
  ...
  ,{ id: 2, word: "auch", ru: "тоже", uk: "також", level: "A1", topics: ["particles"], deSynonyms: [], ruSynonyms: [], ukSynonyms: [], deAntonyms: [], ruAntonyms: [], ukAntonyms: [], examples: [{ L2: "Ich komme auch.", ru: "Я тоже прихожу.", uk: "Я теж приходжу." }] }
  ,{ id: 3, word: "nur", ru: "только", uk: "лише", level: "A1", topics: ["particles"], deSynonyms: [], ruSynonyms: [], ukSynonyms: [], deAntonyms: [], ruAntonyms: [], ukAntonyms: [], examples: [{ L2: "Nur Wasser, bitte.", ru: "Только воду, пожалуйста.", uk: "Тільки воду, будь ласка." }] }
  ,{ id: 4, word: "noch", ru: "еще", uk: "ще", level: "A1", topics: ["particles"], deSynonyms: [], ruSynonyms: [], ukSynonyms: [], deAntonyms: [], ruAntonyms: [], ukAntonyms: [], examples: [{ L2: "Ich lerne noch Deutsch.", ru: "Я ещё учу немецкий.", uk: "Я ще вчу німецьку." }] }
  ,{ id: 5, word: "sehr", ru: "очень", uk: "дуже", level: "A1", topics: ["particles"], deSynonyms: [], ruSynonyms: [], ukSynonyms: [], deAntonyms: [], ruAntonyms: [], ukAntonyms: [], examples: [{ L2: "Das ist sehr gut.", ru: "Это очень хорошо.", uk: "Це дуже добре." }] }
  ,{ id: 6, word: "bitte", ru: "пожалуйста", uk: "будь ласка", level: "A1", topics: ["particles"], deSynonyms: [], ruSynonyms: [], ukSynonyms: [], deAntonyms: [], ruAntonyms: [], ukAntonyms: [], examples: [{ L2: "Ein Kaffee, bitte.", ru: "Один кофе, пожалуйста.", uk: "Одна кава, будь ласка." }] }
  ,{ id: 7, word: "danke", ru: "спасибо", uk: "дякую", level: "A1", topics: ["particles"], deSynonyms: [], ruSynonyms: [], ukSynonyms: [], deAntonyms: [], ruAntonyms: [], ukAntonyms: [], examples: [{ L2: "Danke für deine Hilfe.", ru: "Спасибо за твою помощь.", uk: "Дякую за твою допомогу." }] }
  ,{ id: 8, word: "ja", ru: "да", uk: "так", level: "A1", topics: ["particles"], deSynonyms: [], ruSynonyms: [], ukSynonyms: [], deAntonyms: [], ruAntonyms: [], ukAntonyms: [], examples: [{ L2: "Ja, ich komme.", ru: "Да, я иду.", uk: "Так, я йду." }] }
  ,{ id: 9, word: "nein", ru: "нет", uk: "ні", level: "A1", topics: ["particles"], deSynonyms: [], ruSynonyms: [], ukSynonyms: [], deAntonyms: [], ruAntonyms: [], ukAntonyms: [], examples: [{ L2: "Nein, danke.", ru: "Нет, спасибо.", uk: "Ні, дякую." }] }
  ,{ id: 10, word: "doch", ru: "всё-таки / да", uk: "усе ж таки / так", level: "A1", topics: ["particles"], deSynonyms: [], ruSynonyms: [], ukSynonyms: [], deAntonyms: [], ruAntonyms: [], ukAntonyms: [], examples: [{ L2: "Doch, ich habe Zeit.", ru: "Нет, у меня есть время.", uk: "Ні, у мене є час." }] }];
